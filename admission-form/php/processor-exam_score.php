...
if ( $mysql == true ) {
	$sqladditionalinfo = "INSERT INTO `ncu_admission_2017`.`user_exam_score` (`application_id`, `exam_score`) VALUES ('".mysql_real_escape_string( $finalapplicationid )."','".mysql_real_escape_string( $finalexamscore )."')
		ON DUPLICATE KEY
		UPDATE

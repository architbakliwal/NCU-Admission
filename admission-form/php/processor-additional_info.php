...
if ( $mysql == true ) {
	$sqladditionalinfo = "INSERT INTO `ncu_admission_2017`.`user_additional_info` (`application_id`, `difficult_decision`, `future_plans`) VALUES ('".mysql_real_escape_string( $finalapplicationid )."','".mysql_real_escape_string( $finaldifficultdecision )."','".mysql_real_escape_string( $finalfutureplans )."')
		ON DUPLICATE KEY
		UPDATE

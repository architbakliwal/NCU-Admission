			...
			<form method="post" action="<?php echo $baseurl;?>php/processor-personal.php?lang=<?php echo $_GET['lang'];?>" id="section_personal">
				<fieldset>
					<div class="grid-container">
						...
						<div class="column-six">
							<div class="select-group irequire">
								<label for="hearaboutncu" class="group custom-select">
									<select id="hearaboutncu" name="hearaboutncu" class="select">
										<option value="">How did you hear of NCU?</option>
					    ...
					    <div class="column-six">
							<div class="input-group-right">
								<label for="hearaboutncuother" class="group label-input">
	                                <input type="text" id="hearaboutncuother" name="hearaboutncuother" class="input-right" placeholder="Please Specify">
								</label>
						    </div>
						</div>
